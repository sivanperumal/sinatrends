...
public class CollectionService {
	...
	public List<CollectionResponseDto> getCollectionByCategorySlug(String catergory_slug) {
		// TODO Auto-generated method stub
		List<Collection> collections = collectionRepo.findByCategorySlug(catergory_slug);
