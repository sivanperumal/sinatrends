		...
		if(collectionRepo.count() == 0) {
						...
						List<Collection> demoCollections = List.of(	new Collection(
															...
															new Collection(
																	...
																	"bracelets",
																	"/products/banner/premium_temple_jewellery.png",
																	"/products/micro-gold-plated-bracelets.jpg",
																	true,
																	LocalDateTime.now(),
																	LocalDateTime.now(),
																	findCat("accessories")
															...
															new Collection(
																	...
																	"impon-jewellery",
																	"/products/banner/premium_temple_jewellery.png",
																	"/products/addigai-bangles-with-ad-stone-pearl-pavalam.jpg",
																	true,
																	LocalDateTime.now(),
																	LocalDateTime.now(),
																	findCat("collections")
															...
															new Collection(
																	...
																	"nosepins",
																	"/products/banner/premium_temple_jewellery.png",
																	"/products/Latest-Peacock-Design-Nose-Pin.jpg",
																	true,
																	LocalDateTime.now(),
																	LocalDateTime.now(),
																	findCat("accessories")
															...
															new Collection(
																	...
																	"modern-jewellery",
																	"/products/banner/premium_temple_jewellery.png",
																	"/products/light-green-gold-plated.jpg",
																	true,
																	LocalDateTime.now(),
																	LocalDateTime.now(),
																	findCat("collections")
